...
const ShareYourStory = ({ data }) => {
  ...
  return (
    <Layout>
      <SEO
        title="Share Your TiDB Story"
        description="Share your TiDB Story and connect with our community."
      />
          ...
          <div className="hero-body">
            <div className="container has-text-centered">
              ...
              <h2 className="section-subtitle">
                Share your TiDB story to connect more with our community. As a
                thank you, we’ll ship you an awesome TIDB SWAG.
              </h2>
