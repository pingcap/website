...
![图：SQL Server 数据迁移到 TiDB](https://download.pingcap.com/images/blog/user-case-yiguo/1.png)
...
![图：多套数仓并存](https://download.pingcap.com/images/blog/user-case-yiguo/2.png)
...
![图：TiDB / TiSpark 实时数仓平台](https://download.pingcap.com/images/blog/user-case-yiguo/3.png)
