...
![DBaaS 结构图](https://download.pingcap.com/images/blog/tidb-tools-ecosystems/1.png)
...
DBaaS 结构图可以看到 Cloud TiDB 的分层架构。最下层是容器云，中间一层是 K8s 自身的服务管理和 API Server。我们在此基础上进行扩展，实现各种 Controller 和调度器，自己本地存储管理 Volume Manager，最终通过 Cloud Manager 提供的 RESTful API 进行暴露。可以很容易接一个前端的 Dashboard，或者直接使用 CLI 命令行工具，完成 TiDB 集群实例的统一化管理。
 ...
 ![细节图](https://download.pingcap.com/images/blog/tidb-tools-ecosystems/2.png)
...
![腾讯云](https://download.pingcap.com/images/blog/tidb-tools-ecosystems/3.png)

这是 UCloud 的截图

![UCloud](https://download.pingcap.com/images/blog/tidb-tools-ecosystems/4.png)

有兴趣的同学可以关注一下。

此外，我们提供了 Operator Chart 的安装方式，使用 Helm 工具可以一键通过 Operator 拉起来一套 TiDB 实例。

![Operator Chart](https://download.pingcap.com/images/blog/tidb-tools-ecosystems/5.png)
...
![配置图例](https://download.pingcap.com/images/blog/tidb-tools-ecosystems/6.png)
...
![Lightning](https://download.pingcap.com/images/blog/tidb-tools-ecosystems/7.png)
...
![Wormhole](https://download.pingcap.com/images/blog/tidb-tools-ecosystems/8.png)
...
![TiDB Insight](https://download.pingcap.com/images/blog/tidb-tools-ecosystems/9.png)
...
![Dashboard](https://download.pingcap.com/images/blog/tidb-tools-ecosystems/10.png)
...
![TiDB Monitor & Alerting](https://download.pingcap.com/images/blog/tidb-tools-ecosystems/11.png)	
	
这个是监控的几个截图，这个大家可能都比较熟悉了。

![监控](https://download.pingcap.com/images/blog/tidb-tools-ecosystems/12.png)
