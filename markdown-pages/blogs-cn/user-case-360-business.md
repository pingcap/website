...
![表结构](https://download.pingcap.com/images/blog/user-case-360-business/1-表结构.png)

### 数据库选型：MySQL or TiDB?

说到 TiDB 不得不提其架构。下面结合架构图简单介绍一下 TiDB 对于我们来说最有吸引力的特性。

![TiDB-架构](https://download.pingcap.com/images/blog/user-case-360-business/2-TiDB-架构.png)
...
![部署架构](https://download.pingcap.com/images/blog/user-case-360-business/3-部署架构.png)
...
![Kafka 待写入情况](https://download.pingcap.com/images/blog/user-case-360-business/4-Kafka-待写入情况.png)

查看 Grafana Overview 监控，通过 TiKV 监控项 “scheduler pending commands”，发现 TiKV 227 节点大量等待的命令。

![监控](https://download.pingcap.com/images/blog/user-case-360-business/5-监控.png)

通过 TiKV 监控项“CPU 使用”也可以看出热点都集中在 227 这个 TiKV 节点上。

![监控-2](https://download.pingcap.com/images/blog/user-case-360-business/6-监控-2.png)
...
![PD 监控模块](https://download.pingcap.com/images/blog/user-case-360-business/7-PD-监控模块.png)

在 PD 监控模板中找到 Operator->Schedule operator create->balance-leader，这个参数代表如下图所示：

![参数](https://download.pingcap.com/images/blog/user-case-360-business/8-参数.png)
...
![新表结构](https://download.pingcap.com/images/blog/user-case-360-business/9-新表结构.png)
...
![最终优化效果-1](https://download.pingcap.com/images/blog/user-case-360-business/10-最终优化效果-1.png)

从命令调度的结果来看也比较均衡：

![最终优化效果-2](https://download.pingcap.com/images/blog/user-case-360-business/11-最终优化效果-2.png)
