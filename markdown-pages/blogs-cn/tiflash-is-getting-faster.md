...
![](https://download.pingcap.com/images/blog/tiflash-is-getting-faster/1-count-order-lineorder.png)
...
![](https://download.pingcap.com/images/blog/tiflash-is-getting-faster/2-count-order-date.png)

![](https://download.pingcap.com/images/blog/tiflash-is-getting-faster/3-order-result.png)
...
![](https://download.pingcap.com/images/blog/tiflash-is-getting-faster/4-count-orderdate.png)
...
![](https://download.pingcap.com/images/blog/tiflash-is-getting-faster/5-cop-super-batch.png)
...
![](https://download.pingcap.com/images/blog/tiflash-is-getting-faster/6-join.png)
...
![](https://download.pingcap.com/images/blog/tiflash-is-getting-faster/7-broadcast-join.png)

而这个优化的加速效果也相当明显。我们针对标准的 Star Schema Benchmark 进行了测试，结果如下。

![](https://download.pingcap.com/images/blog/tiflash-is-getting-faster/8-star-schema-benchmark-scale-100.png)
