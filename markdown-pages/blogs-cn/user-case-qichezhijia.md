...
![TiDB 的研发同学到之家进行技术交流](https://download.pingcap.com/images/blog/user-case-qichezhijia/1-技术交流.png)

<div class="caption-center">TiDB 的研发同学到之家进行技术交流</div>

![我们去 TiDB 进行系统的课程培训](https://download.pingcap.com/images/blog/user-case-qichezhijia/2-技术交流-2.png)
...
1.  OLTP 测试：2000 万数据，500 并发线程测试，在 OLTP 场景测试下 TiDB 的响应时间 99% 在 16ms 以内，满足业务需求。且在数据量级越来越大的情况下，TiDB 会体现出更大的优势，后续还可以通过添加 TiDB/PD/TiKV 节点来提高读写性能，如下图所示：
	...
	![3-OLTP-测试](https://download.pingcap.com/images/blog/user-case-qichezhijia/3-OLTP-测试.png)

2.  OLAP 测试：50G TPC-H 测试，TiDB 相较 MySQL 有很大的速度优势：

	![](https://download.pingcap.com/images/blog/user-case-qichezhijia/表格-Query.png)
...
![4-迁移架构图](https://download.pingcap.com/images/blog/user-case-qichezhijia/4-迁移架构图.png)
...
![5-流程](https://download.pingcap.com/images/blog/user-case-qichezhijia/5-流程.png)
...
![6-愚公](https://download.pingcap.com/images/blog/user-case-qichezhijia/6-愚公.png)
...
![7-CDC](https://download.pingcap.com/images/blog/user-case-qichezhijia/7-CDC.png)
...
![8-回滚方案](https://download.pingcap.com/images/blog/user-case-qichezhijia/8-回滚方案.png)
...
![9-解析-Binlog-Protobuf-协议](https://download.pingcap.com/images/blog/user-case-qichezhijia/9-解析-Binlog-Protobuf-协议.png)

<div class="caption-center">解析 Binlog (Protobuf 协议)</div>

![10-通过业务-ID-决定数据写到哪个库表](https://download.pingcap.com/images/blog/user-case-qichezhijia/10-通过业务-ID-决定数据写到哪个库表.png)
...
![11-最终效果](https://download.pingcap.com/images/blog/user-case-qichezhijia/11-最终效果.png)
