...
![1-vipkid-tidb-应用场景-1](https://download.pingcap.com/images/blog/user-case-vipkid/1-vipkid-tidb-应用场景-1.png)
...
![2-vipkid-tidb-应用场景-1](https://download.pingcap.com/images/blog/user-case-vipkid/2-vipkid-tidb-应用场景-2.png)
...
![3-dm-分库分表融合](https://download.pingcap.com/images/blog/user-case-vipkid/3-dm-分库分表融合.png)
...
![4-DM-延迟监控](https://download.pingcap.com/images/blog/user-case-vipkid/4-DM-延迟监控.png)

第二件事就是解决 DM 高可用问题，由于 DM 本身并不具有高可用性，可能一个 DM worker down 的时候能够支持自动拉起，但如果出现整个节点 down 的情况下其实是束手无策的。如下图所示，我们做了一个简单的尝试：

![5-DM-高可用](https://download.pingcap.com/images/blog/user-case-vipkid/5-DM-高可用.png)
...
![6-VIPKID-TiDB-应用场景-3](https://download.pingcap.com/images/blog/user-case-vipkid/6-VIPKID-TiDB-应用场景-3.png)
...
![7-DDL-使用经验](https://download.pingcap.com/images/blog/user-case-vipkid/7-DDL-使用经验.png)
...
![8-VIPKID-TiDB-应用场景-4](https://download.pingcap.com/images/blog/user-case-vipkid/8-VIPKID-TiDB-应用场景-4.png)
...
![9-TiFlash的速度](https://download.pingcap.com/images/blog/user-case-vipkid/9-TiFlash的速度.png)

<div class=”caption-center”>TiFlash</div>

![10-TiKV的速度](https://download.pingcap.com/images/blog/user-case-vipkid/10-TiKV的速度.png)
...
![11-成本对比](https://download.pingcap.com/images/blog/user-case-vipkid/11-成本对比.png)
...
![12-TiFlash](https://download.pingcap.com/images/blog/user-case-vipkid/12-TiFlash.png)
...
![13-引入-TiSpark.](https://download.pingcap.com/images/blog/user-case-vipkid/13-引入-TiSpark.png)

经过对比测试（单个 TiDB server 是 8C 64G 的），分配同样的计算资源给一个小的 TiSpark 集群跑了一个同样的查询，耗时差不多是原来的大概三分之一。下图是改造后给 BI 用的一个 TiDB server 的集群：

![14-改造后的集群](https://download.pingcap.com/images/blog/user-case-vipkid/14-改造后的集群.png)
...
![15-TiDB-Dashboard](https://download.pingcap.com/images/blog/user-case-vipkid/15-TiDB-Dashboard.png)

![16-TiDB-Dashboard-2](https://download.pingcap.com/images/blog/user-case-vipkid/16-TiDB-Dashboard-2.png)
...
![17-BR](https://download.pingcap.com/images/blog/user-case-vipkid/17-BR.png)
