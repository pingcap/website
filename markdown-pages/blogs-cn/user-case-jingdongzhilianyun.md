...
![图 1 什么是“对象”](https://download.pingcap.com/images/blog/user-case-jingdongzhilianyun/1.png)
...
![图 2 如何存储对象（数据量 1B）](https://download.pingcap.com/images/blog/user-case-jingdongzhilianyun/2.png)
...
![图 3 如何存储对象（数据量 100B）](https://download.pingcap.com/images/blog/user-case-jingdongzhilianyun/3.png)
...
![图 4 元数据管理系统 v1.0（1/4）](https://download.pingcap.com/images/blog/user-case-jingdongzhilianyun/4.png)
...
![图 5 元数据管理系统 v1.0（2/4）](https://download.pingcap.com/images/blog/user-case-jingdongzhilianyun/5.png)
...
![图 6 元数据管理系统 v1.0（3/4）](https://download.pingcap.com/images/blog/user-case-jingdongzhilianyun/6.png)
...
![图 7 元数据管理系统 v1.0（4/4）](https://download.pingcap.com/images/blog/user-case-jingdongzhilianyun/7.png)

<div class="caption-center">图 7 元数据管理系统 v1.0（4/4）</div>

**这个解决方案有两个明显的问题，第一数据分布复杂，管理困难；第二，调度不灵活，给后期维护带来很大的困难。**

![图 8 元数据管理系统改进步目标](https://download.pingcap.com/images/blog/user-case-jingdongzhilianyun/8.png)
...
![图 9 元数据管理系统 v2.0](https://download.pingcap.com/images/blog/user-case-jingdongzhilianyun/9.png)
...
![图 10 迁移方案](https://download.pingcap.com/images/blog/user-case-jingdongzhilianyun/10.png)
...
![图 11 双写验证](https://download.pingcap.com/images/blog/user-case-jingdongzhilianyun/11.png)
