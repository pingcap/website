...
date: 2017-03-27
summary: 我们欢迎所有的具有气质的开发者能和 TiDB 一起成长，一起见证数据库领域的革新，改变世界这事儿有时候也不那么难。
tags: ['开源', '社区']
---
...
-  **Documentation**：许多大型项目不会只通过自述文件去引导用户如何使用。在这些项目中你经常可以找到通往其他文件的超链接，或者是在仓库中找到一个叫做 docs 的文件夹.
  ...
  ![TiDB Docs](https://download.pingcap.com/images/blog/how-to-contribute/1.jpg)
...
* **清楚描述你的问题**
    ...
    ![TiDB Issue 模版](https://download.pingcap.com/images/blog/how-to-contribute/2.png)
    
    <div class="caption-center">TiDB Issue 模版</div>

    TiKV Issue 模版如下：
    
    ![TiKV Issue 模版](https://download.pingcap.com/images/blog/how-to-contribute/3.png)
...
![Open Pull Requests](https://download.pingcap.com/images/blog/how-to-contribute/4.png)
...
![二维码](https://download.pingcap.com/images/blog/how-to-contribute/5.jpg)
