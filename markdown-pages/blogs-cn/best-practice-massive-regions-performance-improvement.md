...
![图 1 Raftstore 处理流程示意图](https://download.pingcap.com/images/blog/best-practice-massive-regions-performance-improvement/1.png)
...
* Thread-CPU 下的 `Raft store CPU`
  ...
  ![图 2 查看 Raftstore CPU](https://download.pingcap.com/images/blog/best-practice-massive-regions-performance-improvement/2.png)
...
* Raft Propose 下的 `Propose wait duration`
  ...
  ![图 3 查看 Propose wait duration](https://download.pingcap.com/images/blog/best-practice-massive-regions-performance-improvement/3.png)
...
![图 4 查看 pd-worker](https://download.pingcap.com/images/blog/best-practice-massive-regions-performance-improvement/4.png)
