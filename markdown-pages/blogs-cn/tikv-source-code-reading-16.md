...
![图 1 DAG 样例](https://download.pingcap.com/images/blog/tikv-source-code-reading-16/1.png)
...
![图 2 DAG 执行流程样例](https://download.pingcap.com/images/blog/tikv-source-code-reading-16/2.gif)
...
![图 3 向量化计算模型与标量计算模型对比](https://download.pingcap.com/images/blog/tikv-source-code-reading-16/3.png)
...
![图 4 向量化查询引擎benchmark](https://download.pingcap.com/images/blog/tikv-source-code-reading-16/4.png)
...
![图 5 行存转列存](https://download.pingcap.com/images/blog/tikv-source-code-reading-16/5.png)
...
![图 6 根据 `a` 列的值对行进行分组](https://download.pingcap.com/images/blog/tikv-source-code-reading-16/6.png)

然后，我们会遍历每个组，然后针对每个组求出每个聚合函数的值，在这里就是：

![图 7 遍历每个组求出聚合函数的值](https://download.pingcap.com/images/blog/tikv-source-code-reading-16/7.png)
...
![图 8 遍历所有聚合函数创建的状态](https://download.pingcap.com/images/blog/tikv-source-code-reading-16/8.png)
