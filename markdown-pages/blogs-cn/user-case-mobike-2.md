...
![图 1  两地三中心部署架构图](https://download.pingcap.com/images/blog/user-case-mobike-2/1.png)
...
![图 2 订单集群的迁移过程以及业务接入拓扑图](https://download.pingcap.com/images/blog/user-case-mobike-2/2.png)
...
![图 3  Raft 算法中，Follower 出现网络隔离的场景图](https://download.pingcap.com/images/blog/user-case-mobike-2/3.png)
...
![图 4  在线业务集群拓扑图](https://download.pingcap.com/images/blog/user-case-mobike-2/4.png)
...
![图 5  数据沙盒集群拓扑图](https://download.pingcap.com/images/blog/user-case-mobike-2/5.png)
...
![图 6 监控拓扑图](https://download.pingcap.com/images/blog/user-case-mobike-2/6.png)

<div class="caption-center">图 6 监控拓扑图</div>

![图 7 监控展示图](https://download.pingcap.com/images/blog/user-case-mobike-2/7.png)
