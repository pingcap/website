...
![](https://download.pingcap.com/images/blog/user-case-fengchao/1.jpg)
...
![](https://download.pingcap.com/images/blog/user-case-fengchao/2.jpg)


测试结果：

![](https://download.pingcap.com/images/blog/user-case-fengchao/3.png)

通过～

### 2. 功能测试

![](https://download.pingcap.com/images/blog/user-case-fengchao/4.jpg)
...
![](https://download.pingcap.com/images/blog/user-case-fengchao/5.png)
...
![](https://download.pingcap.com/images/blog/user-case-fengchao/6.jpg)

### 2. 监控能力

TiDB 拥有很完善的监控平台，可以直观的看到容量，以及节点状态：

![](https://download.pingcap.com/images/blog/user-case-fengchao/7.png)

还能了解每个节点负载和 sql 执行的延时：

![](https://download.pingcap.com/images/blog/user-case-fengchao/8.png)


当然还能了解所在机器上的位置，CPU 内存等负载情况：


![](https://download.pingcap.com/images/blog/user-case-fengchao/9.png)


网络状态也能清晰的监控到：

![](https://download.pingcap.com/images/blog/user-case-fengchao/10.png)
