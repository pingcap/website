...
![TiKV 架构](https://download.pingcap.com/images/blog/tikv-how-to-use-raft/1.png)
...
![trait 定义](https://download.pingcap.com/images/blog/tikv-how-to-use-raft/2.png)

我们需要实现自己的 Storage trait，这里详细解释一下各个接口的含义：

initial_state：初始化 Raft Storage 的时候调用，它会返回一个 RaftState，RaftState 的定义如下：

![RaftState 定义](https://download.pingcap.com/images/blog/tikv-how-to-use-raft/3.png)

HardState 和 ConfState 是 protobuf，定义：

![protobuf 定义](https://download.pingcap.com/images/blog/tikv-how-to-use-raft/4.png)
...
![Config 定义](https://download.pingcap.com/images/blog/tikv-how-to-use-raft/5.png)
...
![RawNode 构造函数](https://download.pingcap.com/images/blog/tikv-how-to-use-raft/6.png)
...
![ready 定义](https://download.pingcap.com/images/blog/tikv-how-to-use-raft/7.png)
